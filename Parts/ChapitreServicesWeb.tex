...
\hline
   ...
   &
   REST n'a pas de standard en termes d'intégration et implémentation qui décrit quels formats utiliser ou quelles méthodes utiliser.
Cependant, cet inconvénient peut être résolu avec une bonne documentation et un respect de certaines bonnes pratiques. \\
   \hline
   item 21  & item 22   \\
   \hline
\end{tabu}
